...
<p>We will use Windows PowerShell to immediately update changes for all of the Group Policies. From the taskbar, click the <b>Windows PowerShell</b>. At the PowerShell prompt, type <b>gpupdate /force</b> then press enter.
<hr>
